...
def closewindows():
	...
	if k & 0xFF == ord('s'):
		...
		cv2.imwrite('./character-segmentation-results/'+comment+'_thres'+'.jpg',final_thr)
		cv2.imwrite('./character-segmentation-results/'+comment+'_src'+'.jpg',src_img)
		cv2.imwrite('./character-segmentation-results/'+comment+'_contr'+'.jpg',final_contr)
		print("Completed")
	elif k & 0xFF == int(27):
